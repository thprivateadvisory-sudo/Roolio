...
import {
  ...
  Gem, TrendingUp as TrendUp, Percent, Flag, Medal, Sword
} from "lucide-react";
          ...
          <div style={{ position: "relative", width: 240, height: 240, margin: "0 auto 20px" }}>
            ...
            <motion.div
              ...
              style={{
                ...
                position: "relative", boxShadow: c.shadowLg,
            ...
            >
              {segments.map((s, i) => {
                ...
                return (
                  <div key={i} style={{
                    ...
                    clipPath: `polygon(50% 50%, 50% 0%, ${50 + Math.tan(Math.PI / segments.length) * 50}% 0%)`,
                    background: s.color,
                    display: "flex", justifyContent: "center", paddingTop: 18
                  }}>
                    <div style={{
              ...
              <div style={{
                ...
                width: 50, height: 50, borderRadius: "50%", background: c.text,
                display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2
              }}>
                <Sparkles size={20} color={c.gold} strokeWidth={2.2} />
              </div>
            </motion.div>
          </div>
...
const FeedbackButton = ({ onClick }) => (
  ...
  >
    <MessageCircle size={14} color={c.brand} strokeWidth={2.2} />
    Donner mon avis
  </motion.button>
);
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto", padding: "11px 16px", display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
              ...
              <div onClick={() => setTab("profile")} style={{ display: "flex", alignItems: "center", gap: 7, background: c.surface, border: `1px solid ${c.border}`, borderRadius: 10, padding: "3px 3px 3px 10px", boxShadow: c.shadow, cursor: "pointer" }}>
                <div style={{ textAlign: "right" }}>
                  <motion.div key={user.points} initial={{ scale: 1.1 }} animate={{ scale: 1 }} transition={springSoft}
